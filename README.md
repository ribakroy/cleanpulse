...
1. פעל לפי ההנחיות המופיעות במדריך [docs/GITHUB_DATA_SETUP.md](file:///Users/royribak/Documents/CleanPulse/docs/GITHUB_DATA_SETUP.md) ליצירת מאגר הנתונים וטוקן הגישה.
2. הגדר ב-`.env.local` את ערך ה-`DATA_ADAPTER=github` ומלא את משתני הסביבה המתאימים.
3. להזנת נתונים ראשוניים למאגר ה-GitHub:
   ```bash
   npm run seed:github
   ```
4. לפרטים על ניהול שוטף, גיבויים, שחזורים והתמודדות עם התנגשויות נתונים, עיין במדריך [docs/DATA_REPO_OPERATIONS.md](file:///Users/royribak/Documents/CleanPulse/docs/DATA_REPO_OPERATIONS.md).
...
* [מדריך הגדרת Vercel ומשתני סביבה](file:///Users/royribak/Documents/CleanPulse/docs/VERCEL_DEPLOYMENT.md) – הנחיות מלאות לחיבור הריפו והגדרות הפרויקט.
* [צ'קליסט מוכנות לייצור (Production Checklist)](file:///Users/royribak/Documents/CleanPulse/docs/PRODUCTION_CHECKLIST.md) – שלבי בדיקה ידניים ו-QA לווידוא תקינות המערכת.
