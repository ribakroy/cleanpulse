        ...
        <aside className="h-fit rounded-[var(--radius-lg)] overflow-hidden bg-slate-900 text-white shadow-xl">
          ...
          <div className="px-5 pt-5 pb-4 border-b border-slate-800">
            ...
            >
              ...
              <div className="leading-tight">
                ...
                <span className="block text-[10px] text-brand-water font-semibold tracking-wider uppercase">Owner Console</span>
              </div>
            </Link>
          </div>
          ...
          <div className="px-5 py-4 border-b border-slate-800 bg-slate-950/40">
            ...
            <div className="mt-2 flex flex-wrap gap-1.5">
              <Badge className="bg-brand/10 text-brand-water hover:bg-brand/20 text-[11px] border border-brand/20">
                <ShieldAlert className="size-3 ml-1 text-brand-water" />
                מנהל על
              </Badge>
            </div>
          </div>
